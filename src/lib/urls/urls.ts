...
export const CANONICAL_BASE_URL = 'https://www.my-dino-park.wiki';
...
function getMyDinoParkBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'my-dino-park.wiki' ||
      parsedUrl.hostname === 'www.my-dino-park.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const myDinoParkBaseUrl = getMyDinoParkBaseUrl(configuredBaseUrl);
  if (myDinoParkBaseUrl) {
    return myDinoParkBaseUrl;
  }
