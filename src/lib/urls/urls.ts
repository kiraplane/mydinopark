...
export const CANONICAL_BASE_URL = 'https://www.nophenia.wiki';
...
function getNopheniaBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'nophenia.wiki' ||
      parsedUrl.hostname === 'www.nophenia.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const nopheniaBaseUrl = getNopheniaBaseUrl(configuredBaseUrl);
  if (nopheniaBaseUrl) {
    return nopheniaBaseUrl;
  }
